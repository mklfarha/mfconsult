...
func BookingToProto(e main_entity.Booking) *pb.Booking {
	return &pb.Booking{
		...
		PayLinkToken:     e.PayLinkToken.ValueOrZero(),
		PayLinkExpiresAt: timestamppb.New(e.PayLinkExpiresAt.ValueOrZero()),
		PortalToken:      e.PortalToken.ValueOrZero(),
...
func BookingFromProto(m *pb.Booking) main_entity.Booking {
	...
	return main_entity.Booking{
		...
		PayLinkToken:     null.StringFrom(m.PayLinkToken),
		PayLinkExpiresAt: null.TimeFrom(m.GetPayLinkExpiresAt().AsTime()),
		PortalToken:      null.StringFrom(m.PortalToken),
