...
type Module interface {
	FetchEngagementAgreementById(ctx context.Context, req types.FetchEngagementAgreementByIdRequest, opts ...Option) (types.FetchEngagementAgreementByIdResponse, error)
