...
func mapModelToEntity(m mfconsultdb.Booking) main_entity.Booking {
	return main_entity.Booking{
		...
		PayLinkToken:     null.NewString(m.PayLinkToken.String, m.PayLinkToken.Valid),
		PayLinkExpiresAt: null.NewTime(m.PayLinkExpiresAt.Time, m.PayLinkExpiresAt.Valid),
		PortalToken:      null.NewString(m.PortalToken.String, m.PortalToken.Valid),
